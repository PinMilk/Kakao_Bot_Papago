...
exports.Translator = /** @class */ (function () {
    ...
    Translator.prototype.getHash = function (message) {
        const hash = new HmacMD5()
            .init('v1.5.9_33e53be80f', message)
            .getHash();
        return hash;
    };
    /**
     ...
     * @property {boolean} honorfic weather to translate to honorfic message or not
     * @property {boolean} verbose if it is true, it returns raw json
     * @param {string} source origin language
     * @param {string} target target language
     * @param {string} text string to be translated
     * @param {TranslateConfig} config Translate config
    ...
    /**
     * 
     * @param {string} text Text to be detected language
